...
def manage_customer_from_project(request, id=None):
    ...
    return render_to_response('customer_from_project.html',
        {'customer_form': customer_form, 'address_form': address_form,
          'customer_id':id}, context_instance = RequestContext(request))
...
def manage_customer_contact_from_project(request, id=None):
    ...
    if request.method == 'POST':
        ...
        contact_profile_form = CustomerContactProfileForm(instance
                                        = contact_profile)
    return render_to_response('customer_contact_from_project.html',{
...
def manage_client(request, id = None):
    ...
    if request.method == 'POST':
        ...
        address_form = AddressForm(instance = address)
#    print request  
    return render_to_response('client_create.html', {'form': form,
