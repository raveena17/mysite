...
#        print query
    ...
    return render_to_response('phase.html', {'phase_details': phase_details, 'json_msg': json_msg}, context_instance=RequestContext(request))
...
def delete_phase(request):
    ...
    return render_to_response('phase.html', {'phase_details': phase_details, 'msg': msg, 'bg_color': bg_color, 'color': color}, context_instance=RequestContext(request))
...
def cost_listpage(request):
    ...
    return render_to_response('cost.html', {'cost_list': cost_list, \
    'msg': json_msg, }, context_instance=RequestContext(request))
#def cost_listpage(request):
...
def delete_cost(request):
    ...
    return render_to_response('cost.html', {'cost_list': cost_list, 'msg1': msg1, 'bgcolor': bgcolor, 'color': color, }, context_instance=RequestContext(request))
