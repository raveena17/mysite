...
def display_project_dashboard(request):
    ...
    return render_to_response('projectDashboard.html', {
...
def project_initiation(request, msg = ''):
    ...
    return render_to_response('project.html', {'title': 'Project',
        'action': action,
...
def project_plan(request):
    ...
    return render_to_response('project_plan.html', {
...
def manage_development_environment(request, id = None):
    ...
    return render_to_response('development_environment.html', {
        'form': form})
...
def manage_domain(request, id = ''):
    ...
    return render_to_response('domain.html', {'form': form, 'domainID':id})
...
def manage_project_type(request, id = ''):
    ...
    return render_to_response('project_type.html',
...
def manage_business_unit(request, id = ''):
    ...
    return render_to_response('business_unit.html',
...
def manage_project_group(request, id=None):
    ...
    return render_to_response('project_group.html',
...
def manage_project_initiation_request(request):
    ...
    return render_to_response('project_initiation_request.html',
...
def print_project_details(request,id=None):
    ...
    return render_to_response('Approved_project_print.html',
        {'project': form},
        context_instance = RequestContext(request))
