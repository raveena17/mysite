...
class Reimbursement(models.Model):
    ...
    requested_by = models.ForeignKey(User, related_name = 'requested_by', null = True)
    approved_by = models.ForeignKey(User,related_name = 'approved_by', null = True )
    final_approver = models.ForeignKey(User,related_name = 'final_approver',null = True)
    #requested_date = models.DateField(blank=True, null=True)    
    applied_date = models.DateField(blank=True, null=True) 
    status =  models.ForeignKey(SaveRecordStatus, \
            related_name = "Reimbursement status", blank=True, null=True)    
