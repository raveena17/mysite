...
class AbstractTask(models.Model):
    ...
    assigned_resources = models.ManyToManyField(User,
        verbose_name = _('Assigned Resources'), null=True)
    ...
    editor = models.ForeignKey(User, verbose_name = _('editor'),
        related_name='%s(class)s user', blank = True, null = True)
...
class Task(AbstractTask):
    ...
    project = models.ForeignKey(Project, null=True, blank=True, verbose_name=_('project'))
    ...
    parent = models.ForeignKey('self', null = True, blank = True,
        related_name = '%s(class)s_parent', verbose_name = _('Module'))
