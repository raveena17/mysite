...
urlpatterns += patterns('',
    ...
    # (r'^client_visit_report/', include('project_management.client_visit_report.urls')),
    ...
    (r'^codereview/', include('project_management.code_review.urls', namespace="codereview")),
